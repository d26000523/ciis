...
public class videoonlinememberadapter extends BaseAdapter {
    ...
    public videoonlinememberadapter(Context c, ArrayList<HashMap<String, Object>> appList, int resource, String[] from, int[] to) {
        mAppList = appList;
        mContext = c;
