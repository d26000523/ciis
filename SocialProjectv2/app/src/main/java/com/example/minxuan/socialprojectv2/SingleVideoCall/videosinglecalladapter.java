...
public class videosinglecalladapter extends BaseAdapter {
    ...
    public videosinglecalladapter(Context c, ArrayList<HashMap<String, Object>> appList, String[] from, int[] to){
        mAppList = appList;
        mContext = c;
