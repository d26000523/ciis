...
public class WaveView extends View {
    ...
    private String paintcolor ="#00B6DE";
    ...
    public void setBorder(int width, int color,String Color) {
    ...
    private void createShader() {
        ...
        wavePaint1.setColor(Color.parseColor(paintcolor));
        wavePaint1.setAlpha(40);
        wavePaint1.setAntiAlias(true);

        final Paint wavePaint2 = new Paint();
        wavePaint2.setColor(Color.parseColor(paintcolor));
